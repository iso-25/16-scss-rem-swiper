...
! function() {
        ...
        for (let i = 1; i < arguments.length; i += 1) {
            ...
            if (null != a && (s = a, !("undefined" != typeof window && void 0 !== window.HTMLElement ? s instanceof HTMLElement : s && (1 === s.nodeType || 11 === s.nodeType)))) {
                ...
                for (let t = 0, i = s.length; t < i; t += 1) {
                    ...
                    void 0 !== r && r.enumerable && (p(e[i]) && p(a[i]) ? a[i].__swiper__ ? e[i] = a[i] : c(e[i], a[i]) : !p(e[i]) && p(a[i]) ? (e[i] = {}, a[i].__swiper__ ? e[i] = a[i] : c(e[i], a[i])) : e[i] = a[i])
                }
            }
        }
        var s;
        ...
        $ = e => {
            ...
            if (e.params.rewind || e.params.loop)
                for (let i = a - t; i <= r + t; i += 1) {
                    ...
                    for (let i = Math.max(a - t, 0); i <= Math.min(r + t, s - 1); i += 1) i !== a && (i > r || i < a) && I(e, i)
        };
    var O = {
        updateSize: function() {
            const e = this;
        ...
        updateSlides: function() {
            ...
            let E = s.spaceBetween,
                ...
                C = 0;
            if (void 0 === r) return;
            "string" == typeof E && E.indexOf("%") >= 0 ? E = parseFloat(E.replace("%", "")) / 100 * r : "string" == typeof E && (E = parseFloat(E)), e.virtualSize = -E, p.forEach((e => {
            ...
            for (let i = 0; i < c; i += 1) {
                ...
                if (L = 0, p[i] && (a = p[i]), P && e.grid.updateSlide(i, a, p), !p[i] || "none" !== b(a, "display")) {
                    if ("auto" === s.slidesPerView) {
                        ...
                        if (n && (a.style.transform = "none"), l && (a.style.webkitTransform = "none"), s.roundLengths) L = e.isHorizontal() ? S(a, "width", !0) : S(a, "height", !0);
                        else {
                            const e = t(r, "width"),
                                s = t(r, "padding-left"),
                                i = t(r, "padding-right"),
                    ...
                    } else L = (r - (s.slidesPerView - 1) * E) / s.slidesPerView, s.roundLengths && (L = Math.floor(L)), p[i] && (p[i].style[e.getDirectionLabel("width")] = `${L}px`);
                    p[i] && (p[i].swiperSlideSize = L), g.push(L), s.centeredSlides ? (T = T + L / 2 + M / 2 + E, 0 === M && 0 !== i && (T = T - r / 2 - E), 0 === i && (T = T - r / 2 - E), Math.abs(T) < .001 && (T = 0), s.roundLengths && (T = Math.floor(T)), C % s.slidesPerGroup == 0 && m.push(T), h.push(T)) : (s.roundLengths && (T = Math.floor(T)), (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && m.push(T), h.push(T), T = T + L + E), e.virtualSize += L + E, M = L, C += 1
                }
            }
            if (e.virtualSize = Math.max(e.virtualSize, r) + w, n && l && ("slide" === s.effect || "coverflow" === s.effect) && (i.style.width = `${e.virtualSize+E}px`), s.setWrapperSize && (i.style[e.getDirectionLabel("width")] = `${e.virtualSize+E}px`), P && e.grid.updateWrapperSize(L, m), !s.centeredSlides) {
                const t = [];
            ...
            if (o && s.loop) {
                ...
                for (let i = 0; i < e.virtual.slidesBefore + e.virtual.slidesAfter; i += 1) 1 === s.slidesPerGroup && m.push(m[m.length - 1] + t), h.push(h[h.length - 1] + t), e.virtualSize += t
            }
            ...
            if (c !== d && e.emit("slidesLengthChange"), m.length !== y && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), h.length !== x && e.emit("slidesGridLengthChange"), s.watchSlidesProgress && e.updateSlidesOffset(), !(o || s.cssMode || "slide" !== s.effect && "fade" !== s.effect)) {
        ...
        updateSlidesProgress: function(e) {
            ...
            for (let e = 0; e < i.length; e += 1) {
                ...
                (u >= 0 && u < t.size - 1 || m > 1 && m <= t.size || u <= 0 && m >= t.size) && (t.visibleSlides.push(o), t.visibleSlidesIndexes.push(e), i[e].classList.add(s.slideVisibleClass)), h && i[e].classList.add(s.slideFullyVisibleClass), o.progress = a ? -p : p, o.originalProgress = a ? -c : c
            }
        },
        ...
        updateSlidesClasses: function() {
            ...
            else n ? (o = t.filter((e => e.column === a))[0], p = t.filter((e => e.column === a + 1))[0], d = t.filter((e => e.column === a - 1))[0]) : o = t[a];
            o && (o.classList.add(s.slideActiveClass), n ? (p && p.classList.add(s.slideNextClass), d && d.classList.add(s.slidePrevClass)) : (p = function(e, t) {
                const s = [];
                ...
                return s
            }(o, `.${s.slideClass}, swiper-slide`)[0], s.loop && !p && (p = t[0]), p && p.classList.add(s.slideNextClass), d = function(e, t) {
                const s = [];
        ...
        updateActiveIndex: function(e) {
            ...
            Object.assign(t, {
                ...
                previousIndex: r,
                activeIndex: d
            }), t.initialized && $(t), t.emit("activeIndexChange"), t.emit("snapIndexChange"), (t.initialized || t.params.runCallbacksOnInit) && (n !== u && t.emit("realIndexChange"), t.emit("slideChange"))
        },
    ...
    var G = {
        slideTo: function(e, t, s, i, a) {
            ...
            let b;
            if (n !== (p || 0) && s && r.emit("beforeSlideChangeStart"), r.updateProgress(w), b = n > c ? "next" : n < c ? "prev" : "reset", u && -w === r.translate || !u && w === r.translate) return r.updateActiveIndex(n), l.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), "slide" !== l.effect && r.setTranslate(w), "reset" !== b && (r.transitionStart(s, b), r.transitionEnd(s, b)), !1;
            if (l.cssMode) {
                const e = r.isHorizontal(),
                    s = u ? w : -w;
                if (0 === t) {
        ...
        slideToClickedSlide: function() {
            ...
            if (t.loop) {
                ...
                a = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), t.centeredSlides ? r < e.loopedSlides - i / 2 || r > e.slides.length - e.loopedSlides + i / 2 ? (e.loopFix(), r = e.getSlideIndex(f(s, `${n}[data-swiper-slide-index="${a}"]`)[0]), l((() => {
                    e.slideTo(r)
                }))) : e.slideTo(r) : r > e.slides.length - i ? (e.loopFix(), r = e.getSlideIndex(f(s, `${n}[data-swiper-slide-index="${a}"]`)[0]), l((() => {
                    e.slideTo(r)
                }))) : e.slideTo(r)
            } else e.slideTo(r)
        }
    ...
    var B = {
        ...
        loopFix: function(e) {
            ...
            if (o.__preventObserver__ = !0, requestAnimationFrame((() => {
                ...
                })), o.recalcSlides(), "auto" === m.slidesPerView ? o.updateSlides() : b && (y.length > 0 && T || x.length > 0 && S) && o.slides.forEach(((e, t) => {
                ...
                if (y.length > 0 && T) {
                    if (void 0 === t) {
                        ...
                        l ? o.setTranslate(o.translate - t) : (o.slideTo(E + M, 0, !1, !0), a && (o.touchEventsData.startTranslate = o.touchEventsData.startTranslate - t, o.touchEventsData.currentTranslate = o.touchEventsData.currentTranslate - t))
                    } else if (a) {
    ...
    function H(e) {
        ...
        let w = !0;
        c.matches(n.focusableElements) && (w = !1, "SELECT" === c.nodeName && (n.isTouched = !1)), s.activeElement && s.activeElement.matches(n.focusableElements) && s.activeElement !== c && s.activeElement.blur();
        const b = w && t.allowTouchMove && l.touchStartPreventDefault;
        !l.touchStartForcePreventDefault && !b || c.isContentEditable || a.preventDefault(), l.freeMode && l.freeMode.enabled && t.freeMode && t.animating && !l.cssMode && t.freeMode.onTouchStart(), t.emit("touchStart", a)
    }
    ...
    function R(e) {
        ...
        a.allowTouchCallbacks && s.emit("touchMove", c), n.previousX = n.currentX, n.previousY = n.currentY, n.currentX = u, n.currentY = m;
        ...
        if (a.isScrolling && s.emit("touchMoveOpposite", c), void 0 === a.startMoving && (n.currentX === n.startX && n.currentY === n.startY || (a.startMoving = !0)), a.isScrolling) return void(a.isTouched = !1);
        ...
        let x = !0,
            E = r.resistanceRatio;
        if (r.touchReleaseOnEdges && (E = 0), g > 0 ? (b && y && a.allowThresholdMove && a.currentTranslate > (r.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] : s.minTranslate()) && s.loopFix({
                direction: "prev",
                setTranslate: !0,
                activeSlideIndex: 0
            }), a.currentTranslate > s.minTranslate() && (x = !1, r.resistance && (a.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + a.startTranslate + g) ** E))) : g < 0 && (b && y && a.allowThresholdMove && a.currentTranslate < (r.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] : s.maxTranslate()) && s.loopFix({
                direction: "next",
                setTranslate: !0,
    ...
    function X(e) {
        ...
        for (let e = 0; e < p.length; e += e < r.slidesPerGroupSkip ? 1 : r.slidesPerGroup) {
            ...
            void 0 !== p[e + t] ? h >= p[e] && h < p[e + t] && (f = e, g = p[e + t] - p[e]) : h >= p[e] && (f = e, g = p[p.length - 1] - p[p.length - 2])
        }
        let v = null,
            w = null;
        ...
        if (m > r.longSwipesMs) {
            ...
            t.navigation && (a.target === t.navigation.nextEl || a.target === t.navigation.prevEl) ? a.target === t.navigation.nextEl ? t.slideTo(f + y) : t.slideTo(f) : ("next" === t.swipeDirection && t.slideTo(null !== v ? v : f + y), "prev" === t.swipeDirection && t.slideTo(null !== w ? w : f))
        }
    }
    ...
    const W = (e, t) => {
        ...
        s[d]("touchstart", e.onDocumentTouchStart, {
            ...
            passive: !0
        }), (a.preventClicks || a.preventClicksPropagation) && r[d]("click", e.onClick, !0), a.cssMode && n[d]("scroll", e.onScroll), a.updateOnWindowResize ? e[p](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", Y, !0) : e[p]("observerUpdate", Y, !0), r[d]("load", e.onLoad, {
            capture: !0
        })
    };
    ...
    const Q = {
            ...
            events: {
                attachEvents: function() {
                    ...
                    e.onTouchStart = H.bind(e), e.onTouchMove = R.bind(e), e.onTouchEnd = X.bind(e), e.onDocumentTouchStart = F.bind(e), t.cssMode && (e.onScroll = V.bind(e)), e.onClick = q.bind(e), e.onLoad = j.bind(e), W(e, "on")
                },
    ...
    class ee {
        constructor() {
            ...
            const d = c({}, K, o);
            return l.params = c({}, d, J, t), l.originalParams = c({}, l.params), l.passedParams = c({}, t), l.params && l.params.on && Object.keys(l.params.on).forEach((e => {
        ...
        getSlideIndex(e) {
            const {
                slidesEl: t,
                params: s
            } = this, i = y(f(t, `.${s.slideClass}, swiper-slide`)[0]);
            return y(e) - i
        }
        ...
        mount(e) {
            ...
            return !a && t.params.createElements && (a = v("div", t.params.wrapperClass), s.append(a), f(s, `.${t.params.slideClass}`).forEach((e => {
                a.append(e)
            }))), Object.assign(t, {
                el: s,
                wrapperEl: a,
    ...
    const ue = [function(e) {
        ...
        function p(e) {
            ...
            if (r && g >= b ? (y -= b, a || (E += s.slidesGrid[0])) : r && g < b && (y = -b, a && (E += s.slidesGrid[0])), Object.assign(s.virtual, {
                    ...
                    slidesBefore: b,
                    slidesAfter: w
                }), p === y && c === x && !e) return s.slidesGrid !== m && E !== h && s.slides.forEach((e => {
        ...
        r("beforeInit", (() => {
            ...
            e || (s.virtual.slides = s.params.virtual.slides), s.classNames.push(`${s.params.containerModifierClass}virtual`), s.params.watchSlidesProgress = !0, s.originalParams.watchSlidesProgress = !0, p()
        })), r("setTranslate", (() => {
            ...
            removeSlide: function(e) {
                ...
                let t = s.activeIndex;
                if (Array.isArray(e))
                    for (let i = e.length - 1; i >= 0; i -= 1) s.params.virtual.cache && (delete s.virtual.cache[e[i]], Object.keys(s.virtual.cache).forEach((t => {
                        t > e && (s.virtual.cache[t - 1] = s.virtual.cache[t], s.virtual.cache[t - 1].setAttribute("data-swiper-slide-index", t - 1), delete s.virtual.cache[t])
                    }))), s.virtual.slides.splice(e[i], 1), e[i] < t && (t -= 1), t = Math.max(t, 0);
        ...
        function f(e) {
            return !(t.params.mousewheel.thresholdDelta && e.delta < t.params.mousewheel.thresholdDelta) && (!(t.params.mousewheel.thresholdTime && o() - c < t.params.mousewheel.thresholdTime) && (e.delta >= 6 && o() - c < 60 || (e.direction < 0 ? t.isEnd && !t.params.loop || t.animating || (t.slideNext(), a("scroll", e.raw)) : t.isBeginning && !t.params.loop || t.animating || (t.slidePrev(), a("scroll", e.raw)), c = (new n.Date).getTime(), !1)))
        }
            ...
            if (v >= t.minTranslate() && (v = t.minTranslate()), v <= t.maxTranslate() && (v = t.maxTranslate()), i = !!t.params.loop || !(v === t.minTranslate() || v === t.maxTranslate()), i && t.params.nested && s.stopPropagation(), t.params.freeMode && t.params.freeMode.enabled) {
                ...
                if (!i) {
                    ...
                    const o = t.isBeginning,
                        c = t.isEnd;
                    if (n >= t.minTranslate() && (n = t.minTranslate()), n <= t.maxTranslate() && (n = t.maxTranslate()), t.setTransition(0), t.setTranslate(n), t.updateProgress(), t.updateActiveIndex(), t.updateSlidesClasses(), (!o && t.isBeginning || !c && t.isEnd) && t.updateSlidesClasses(), t.params.loop && t.loopFix({
        ...
        function u() {
            ...
            if (t.params.loop ? (r = t.previousRealIndex || 0, i = t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex) : void 0 !== t.snapIndex ? (i = t.snapIndex, r = t.previousSnapIndex) : (r = t.previousIndex || 0, i = t.activeIndex || 0), "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                ...
                let o, d, u;
                if (s.dynamicBullets && (n = S(a[0], t.isHorizontal() ? "width" : "height", !0), c.forEach((e => {
            ...
            c.forEach(((e, r) => {
                if ("fraction" === s.type && (e.querySelectorAll(se(s.currentClass)).forEach((e => {
                    ...
                    let n = 1,
                        l = 1;
                    "horizontal" === a ? n = r : l = r, e.querySelectorAll(se(s.progressbarFillClass)).forEach((e => {
        ...
        function g() {
            ...
            let l = p,
                o = (c - p) * n;
            s ? (o = -o, o > 0 ? (l = p - o, o = 0) : -o + p > c && (l = c + o)) : o < 0 ? (l = p + o, o = 0) : o + p > c && (l = c - o), t.isHorizontal() ? (i.style.transform = `translate3d(${o}px, 0, 0)`, i.style.width = `${l}px`) : (i.style.transform = `translate3d(0px, ${o}px, 0)`, i.style.height = `${l}px`), r.hide && (clearTimeout(h), a.style.opacity = 1, h = setTimeout((() => {
        ...
        function x(e) {
            ...
            let r;
            r = (y(e) - w(a)[t.isHorizontal() ? "left" : "top"] - (null !== d ? d : p / 2)) / (c - p), r = Math.max(Math.min(r, 1), 0), i && (r = 1 - r);
        ...
        function E(e) {
            ...
            m = !0, d = e.target === l ? y(e) - e.target.getBoundingClientRect()[t.isHorizontal() ? "left" : "top"] : null, e.preventDefault(), e.stopPropagation(), a.style.transitionDuration = "100ms", l.style.transitionDuration = "100ms", x(e), clearTimeout(f), n.style.transitionDuration = "0ms", s.hide && (n.style.opacity = 1), t.params.cssMode && (t.wrapperEl.style["scroll-snap-type"] = "none"), r("scrollbarDragStart", e)
        }
        ...
        function T(e) {
            ...
            m && (m = !1, t.params.cssMode && (t.wrapperEl.style["scroll-snap-type"] = "", a.style.transitionDuration = ""), s.hide && (clearTimeout(f), f = l((() => {
        ...
        function M(e) {
            ...
            r[d]("pointerdown", E, n), o[d]("pointermove", S, n), o[d]("pointerup", T, l)
        }
        ...
        function C() {
            ...
            t.params.uniqueNavElements && "string" == typeof i.el && a.length > 1 && 1 === s.querySelectorAll(i.el).length && (a = s.querySelector(i.el)), a.length > 0 && (a = a[0]), a.classList.add(t.isHorizontal() ? i.horizontalClass : i.verticalClass), a && (r = a.querySelector(se(t.params.scrollbar.dragClass)), r || (r = v("div", t.params.scrollbar.dragClass), a.append(r))), Object.assign(e, {
                el: a,
                dragEl: r
            }), i.draggable && t.params.scrollbar.el && t.scrollbar.el && M("on"), a && a.classList[t.enabled ? "remove" : "add"](...n(t.params.scrollbar.lockClass))
        }
        ...
        const a = "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]",
            ...
            n = () => {
                ...
                t.isElement && o.push(...f(t.hostEl, a)), o.forEach((e => {
                    r(e, i)
                })), s.forEach(((e, s) => {
                    let l = e.progress;
        ...
        function E(e) {
            ...
            if (l = !1, o = !1, u.push(e), !(u.length < 2)) {
                if (l = !0, m.scaleStart = b(), !m.slideEl) {
                    ...
                    if (i && (i = i.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), m.imageEl = i, m.imageWrapEl = i ? x(m.imageEl, `.${s.containerClass}`)[0] : void 0, !m.imageWrapEl) return void(m.imageEl = void 0);
        ...
        function S(e) {
            ...
            a >= 0 && (u[a] = e), u.length < 2 || (o = !0, m.scaleMove = b(), m.imageEl && (i.scale = m.scaleMove / m.scaleStart * p, i.scale > m.maxRatio && (i.scale = m.maxRatio - 1 + (i.scale - m.maxRatio + 1) ** .5), i.scale < s.minRatio && (i.scale = s.minRatio + 1 - (s.minRatio - i.scale + 1) ** .5), m.imageEl.style.transform = `translate3d(0,0,0) scale(${i.scale})`))
        }
        ...
        function M(e) {
            ...
            h.minX = Math.min(m.slideWidth / 2 - i / 2, 0), h.maxX = -h.minX, h.minY = Math.min(m.slideHeight / 2 - a / 2, 0), h.maxY = -h.minY, h.touchesCurrent.x = u.length > 0 ? u[0].pageX : e.pageX, h.touchesCurrent.y = u.length > 0 ? u[0].pageY : e.pageY;
        ...
        s({
            ...
            setTransition: function(e, s) {
                ...
                if (Array.isArray(a))
                    for (r = 0; r < a.length; r += 1) a[r] !== s && a[r] instanceof i && n(a[r]);
        ...
        i("beforeInit", (() => {
            ...
            t.params.a11y.enabled && function() {
                ...
                f() && t.pagination.bullets.forEach((s => {
                    t.params.pagination.clickable && (l(s), t.params.pagination.renderBullet || (d(s, "button"), c(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, y(s) + 1)))), s.matches(se(t.params.pagination.bulletActiveClass)) ? s.setAttribute("aria-current", "true") : s.removeAttribute("aria-current")
                }))
            }()
        })), i("destroy", (() => {
            t.params.a11y.enabled && function() {
        ...
        let d, p, c, u, m, h, f, g, v = o && o.autoplay ? o.autoplay.delay : 3e3,
        ...
        const x = () => {
            ...
            C = () => {
                a.isEnd && d < 0 && !a.params.loop || a.destroyed || !a.autoplay.running || (b = (new Date).getTime(), f ? (f = !1, E(d)) : E(), a.autoplay.paused = !1, l("autoplayResume"))
            },
            P = () => {
                if (a.destroyed || !a.autoplay.running) return;
                const e = i();
        ...
        n("init", (() => {
            a.params.autoplay.enabled && (a.params.autoplay.pauseOnMouseEnter && (a.el.addEventListener("pointerenter", L), a.el.addEventListener("pointerleave", z)), i().addEventListener("visibilitychange", P), S())
        })), n("destroy", (() => {
            a.el.removeEventListener("pointerenter", L), a.el.removeEventListener("pointerleave", z), i().removeEventListener("visibilitychange", P), a.autoplay.running && T()
            ...
            !a.destroyed && a.autoplay.running && (a.params.autoplay.disableOnInteraction ? T() : (c = !0, u = !1, f = !1, m = setTimeout((() => {
                f = !0, u = !0, M(!0)
            }), 200)))
        })), n("touchEnd", (() => {
        ...
        function d(e) {
            ...
            if (t.params.slidesPerView > 1 && !t.params.centeredSlides && (a = t.params.slidesPerView), t.params.thumbs.multipleActiveThumbs || (a = 1), a = Math.floor(a), s.slides.forEach((e => e.classList.remove(r))), s.params.loop || s.params.virtual && s.params.virtual.enabled)
                for (let e = 0; e < a; e += 1) f(s.slidesEl, `[data-swiper-slide-index="${t.realIndex+e}"]`).forEach((e => {
                    e.classList.add(r)
                }));
            else
                        ...
                        if (r.freeMode.momentum) {
                            if (p.velocities.length > 1) {
                                const e = p.velocities.pop(),
                                    ...
                                    a = e.time - s.time;
                                t.velocity = i / a, t.velocity /= 2, Math.abs(t.velocity) < r.freeMode.minimumVelocity && (t.velocity = 0), (a > 150 || o() - e.time > 300) && (t.velocity = 0)
                            } else t.velocity = 0;
                            ...
                            r.freeMode.momentumBounce && m ? (t.updateProgress(u), t.setTransition(e), t.setTranslate(c), t.transitionStart(!0, t.swipeDirection), t.animating = !0, E(n, (() => {
                                t && !t.destroyed && p.allowMomentumBounce && (i("momentumBounce"), t.setTransition(r.speed), setTimeout((() => {
                                    t.setTranslate(u), E(n, (() => {
                                        t && !t.destroyed && t.transitionEnd()
                                    }))
                                }), 0))
                            }))) : t.velocity ? (i("_freeModeNoMomentumRelease"), t.updateProgress(c), t.setTransition(e), t.setTranslate(c), t.transitionStart(!0, t.swipeDirection), t.animating || (t.animating = !0, E(n, (() => {
                                t && !t.destroyed && t.transitionEnd()
                            })))) : t.updateProgress(c), t.updateActiveIndex(), t.updateSlidesClasses()
                        } else {
                            if (r.freeMode.sticky) return void t.slideToClosest();
                            r.freeMode && i("_freeModeNoMomentumRelease")
                        }(!r.freeMode.momentum || c >= r.longSwipesMs) && (i("_freeModeStaticRelease"), t.updateProgress(), t.updateActiveIndex(), t.updateSlidesClasses())
                    }
                }
            }
        })
        ...
        l("init", (() => {
            ...
            updateSlide: (e, a, n) => {
                ...
                a.row = f, a.column = h, a.style.height = `calc((100% - ${(p-1)*d}px) / ${p})`, a.style[r.getDirectionLabel("margin-top")] = 0 !== f ? d && `${d}px` : "", a.swiperSlideGridSet = !0
            },
            updateWrapperSize: (e, s) => {
                ...
                if (r.virtualSize = (e + n) * t, r.virtualSize = Math.ceil(r.virtualSize / l) - n, r.params.cssMode || (r.wrapperEl.style[r.getDirectionLabel("width")] = `${r.virtualSize+n}px`), i) {
                    const e = [];
        ...
        const a = (e, t, s) => {
            ...
            i || (i = v("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (s ? "left" : "top")).split(" ")), e.append(i)), a || (a = v("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (s ? "right" : "bottom")).split(" ")), e.append(a)), i && (i.style.opacity = Math.max(-t, 0)), a && (a.style.opacity = Math.max(t, 0))
        };
        oe({
            effect: "cube",
            swiper: t,
            ...
            setTranslate: () => {
                ...
                let m, h = 0;
                p.shadow && (c ? (m = t.wrapperEl.querySelector(".swiper-cube-shadow"), m || (m = v("div", "swiper-cube-shadow"), t.wrapperEl.append(m)), m.style.height = `${r}px`) : (m = e.querySelector(".swiper-cube-shadow"), m || (m = v("div", "swiper-cube-shadow"), e.append(m))));
                for (let e = 0; e < i.length; e += 1) {
                    const s = i[e];
                    let r = e;
                    ...
                    let f = 0,
                        g = 0,
                        v = 0;
                    r % 4 == 0 ? (f = 4 * -d * o, v = 0) : (r - 1) % 4 == 0 ? (f = 0, v = 4 * -d * o) : (r - 2) % 4 == 0 ? (f = o + 4 * d * o, v = o) : (r - 3) % 4 == 0 && (f = -o, v = 3 * o + 4 * o * d), l && (f = -f), c || (g = f, f = 0);
                    const w = `rotateX(${c?0:-n}deg) rotateY(${c?n:0}deg) translate3d(${f}px, ${g}px, ${v}px)`;
                    m <= 1 && m > -1 && (h = 90 * r + 90 * m, l && (h = 90 * -r - 90 * m), t.browser && t.browser.isSafari && Math.abs(h) / 90 % 2 == 1 && (h += .001)), s.style.transform = w, p.slideShadows && a(s, m, c)
                }
                if (s.style.transformOrigin = `50% 50% -${o/2}px`, s.style["-webkit-transform-origin"] = `50% 50% -${o/2}px`, p.shadow)
                    if (c) m.style.transform = `translate3d(0px, ${r/2+p.shadowOffset}px, ${-r/2}px) rotateX(89.99deg) rotateZ(0deg) scale(${p.shadowScale})`;
                    else {
        ...
        const a = (e, s) => {
            ...
            i || (i = ce("flip", e, t.isHorizontal() ? "left" : "top")), a || (a = ce("flip", e, t.isHorizontal() ? "right" : "bottom")), i && (i.style.opacity = Math.max(-s, 0)), a && (a.style.opacity = Math.max(s, 0))
        };
        oe({
            effect: "flip",
            swiper: t,
            ...
            setTranslate: () => {
                ...
                for (let r = 0; r < e.length; r += 1) {
                    ...
                    let d = -180 * l,
                        ...
                        u = 0;
                    t.isHorizontal() ? s && (d = -d) : (u = c, c = 0, p = -d, d = 0), t.browser && t.browser.isSafari && (Math.abs(d) / 90 % 2 == 1 && (d += .001), Math.abs(p) / 90 % 2 == 1 && (p += .001)), n.style.zIndex = -Math.abs(Math.round(l)) + e.length, i.slideShadows && a(n, l);
            ...
            setTranslate: () => {
                ...
                for (let e = 0, s = i.length; e < s; e += 1) {
                    ...
                    if (de(0, s).style.transform = y, s.style.zIndex = 1 - Math.abs(Math.round(u)), r.slideShadows) {
                        ...
                        e || (e = ce("coverflow", s, n ? "left" : "top")), t || (t = ce("coverflow", s, n ? "right" : "bottom")), e && (e.style.opacity = u > 0 ? u : 0), t && (t.style.opacity = -u > 0 ? -u : 0)
                    }
                }
            },
            setTransition: e => {
            ...
            setTranslate: () => {
                ...
                for (let s = 0; s < e.length; s += 1) {
                    ...
                    d < 0 ? (f = r.next, h = !0) : d > 0 && (f = r.prev, h = !0), u.forEach(((e, t) => {
                        ...
                        t.browser && t.browser.isSafari && Math.abs(i) / 90 % 2 == 1 && (i += .001), m[s] = i
            ...
            setTranslate: () => {
                ...
                for (let o = 0; o < e.length; o += 1) {
                    ...
                    if (a.slideShadows) {
                        ...
                        e || (e = ce("cards", d)), e && (e.style.opacity = Math.min(Math.max((Math.abs(c) - .5) / .5, 0), 1))
                    }
    ...
    function be(e, t, s) {
        ...
        return "string" == typeof t && void 0 !== s && l.push({
            ...
            if (t) {
                ...
                const s = ve(e.value);
                a[t] && we.includes(e.name) && !he(s) ? (a[t].constructor !== Object && (a[t] = {}), a[t].enabled = !!s) : a[t] = s
            }
        })), fe(i, a), i.navigation ? i.navigation = {
            prevEl: ".swiper-button-prev",
            nextEl: ".swiper-button-next",
    ...
    const xe = "undefined" == typeof window || "undefined" == typeof HTMLElement ? class {} : HTMLElement,
    ...
    class Te extends xe {
        ...
        render() {
            ...
            this.slideSlots > 0 && (e = e.replace(/::slotted\(([a-z-0-9.]*)\)/g, "$1")), e.length && Se(this.shadowRoot, e), this.cssLinks().forEach((e => {
        ...
        initialize() {
            ...
            this.swiperParams = t, this.passedParams = s, delete this.swiperParams.init, this.render(), this.swiper = new ee(this.shadowRoot.querySelector(".swiper"), { ...t.virtual ? {} : {
                    observer: !0,
        ...
        updateSwiperOnPropChange(e, t) {
            ...
            this.passedParams = i, this.swiperParams = s, this.swiper && this.swiper.params[e] === t || function(e) {
                let {
                    swiper: t,
                    slides: s,
                    passedParams: i,
                ...
                a.includes("loop") && t.isElement && (p.loop && !i.loop ? x = !0 : !p.loop && i.loop ? E = !0 : S = !0), d.forEach((e => {
                    if (he(p[e]) && he(i[e])) Object.assign(p[e], i[e]), "navigation" !== e && "pagination" !== e && "scrollbar" !== e || !("enabled" in i[e]) || i[e].enabled || T(e);
                    else {
                        const t = i[e];
    ...
    me.forEach((e => {
        "init" !== e && (e = e.replace("_", ""), Object.defineProperty(Te.prototype, e, {
            configurable: !0,
            get() {
    ...
    "undefined" != typeof window && (window.SwiperElementRegisterParams = e => {
        me.push(...e)
    }), "undefined" != typeof window && (window.customElements.get("swiper-container") || window.customElements.define("swiper-container", Te), window.customElements.get("swiper-slide") || window.customElements.define("swiper-slide", Me))
}();
